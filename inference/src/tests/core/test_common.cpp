...
TEST_CASE("squash::bf16ToFloat", "[squash]") {
    REQUIRE(bf16ToFloat(bf16{0x4147}) == 12.4375f);
    REQUIRE(bf16ToFloat(bf16{-0x3f80}) == -4.0f);
    REQUIRE(floatToBf16(12.4375f)._intValue == 0x4147);
    REQUIRE(floatToBf16(-4.0f)._intValue == -0x3f80);
